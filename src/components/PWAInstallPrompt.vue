  ...
  <div v-if="showInstallPrompt" class="fixed bottom-4 right-4 z-50">
    ...
    >
      <div class="flex items-start space-x-3">
        ...
        <div class="flex-1">
          <h3 class="text-normal-text font-nasa text-sm font-bold mb-1">
            Installer l'app ACS Gaming
          </h3>
          <p class="text-normal-text-muted text-xs mb-3">
        ...
        <button
          @click="dismissPrompt"
          class="flex-shrink-0 text-normal-text-muted hover:text-normal-text transition-colors"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-4 w-4"
