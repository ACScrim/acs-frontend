  ...
  <div class="space-y-6">
              ...
              >
                ...
                >
                  <div
                    ...
                    :key="player._id"
                    class="text-xs bg-background-bg-light/30 p-2 rounded flex items-center"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              >
                ...
                >
                  <div
                    v-for="player in team.players"
                    :key="player._id"
                    class="text-sm bg-background-bg-light/30 p-2 rounded flex items-center"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-4 w-4 mr-2 flex-shrink-0 text-color-accent-light"
    ...
    >
      ...
      <button
        ...
        class="w-full text-left p-4 rounded-lg border border-background-bg-light/50 flex justify-between items-center hover:bg-background-bg-light/10 transition-colors"
      >
      ...
      <div
        ...
        class="mt-4 space-y-4 p-4 rounded-lg bg-background-bg-light/5 border border-background-bg-light/30 space-fade-in"
      >
        <!-- Tableau des autres équipes -->
        <div class="overflow-x-auto">
          <table class="min-w-full text-normal-text">
            <thead>
              <tr
                class="bg-background-bg-light/20 border-b border-color-primary/20"
              >
                <th
            ...
            <tbody>
              ...
              <tr
                ...
                :key="team._id"
                :class="{
                  'bg-background-bg-light/10':
                    sortedTeamsBeyondPodium.indexOf(team) % 2 === 0,
                  'hover:bg-background-bg-light/20': true,
                }"
                class="transition-colors border-b border-background-bg-light/10"
              >
                ...
                <td class="py-3 px-4">
                  <div class="flex flex-wrap gap-1 justify-center">
                    <span
                      v-for="player in team.players"
                      :key="player._id"
                      class="text-xs bg-background-bg-light/20 px-2 py-1 rounded inline-flex items-center"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
              ...
              <tr
                ...
                :key="team._id"
                :class="{
                  'bg-background-bg-light/5':
                    unrankedTeams.indexOf(team) % 2 === 0,
                  'hover:bg-background-bg-light/15': true,
                }"
                class="transition-colors border-b border-background-bg-light/10 text-normal-text-muted"
              >
                <td class="py-3 px-4 text-center font-mono">
                  <SpaceBadge
                    variant="secondary"
                ...
                <td class="py-3 px-4">
                  <div class="flex flex-wrap gap-1 justify-center">
                    <span
                      v-for="player in team.players"
                      :key="player._id"
                      class="text-xs bg-background-bg-light/10 px-2 py-1 rounded inline-flex items-center"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="h-3 w-3 mr-1 text-normal-text-muted"
                        viewBox="0 0 20 20"
                        fill="currentColor"
                      >
                        <path
