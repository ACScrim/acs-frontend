  ...
  >
      ...
      <div v-if="selectedTournamentDetails">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          ...
          <div
            ...
            class="flex flex-col"
          >
            <span class="text-normal-text-muted text-sm">Discord</span>
            <span class="text-normal-text font-mono text-lg">
    ...
    <div v-if="teams.length > 0">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <!-- Liste des joueurs -->
          <div class="mb-6">
            <SpaceTitle size="sm" className="text-normal-text-muted mb-3">
              Membres de l'équipe:
            </SpaceTitle>
          ...
          <div class="border-t border-space-border pt-4">
            <div class="flex items-center justify-between mb-3">
              <SpaceTitle size="sm" className="text-normal-text-muted">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
    ...
    >
      ...
      <div class="space-y-4">
        ...
        <div class="text-normal-text-muted leading-relaxed">
          Êtes-vous sûr de vouloir terminer ce tournoi ? Les conséquences seront
          :
        </div>

        <div
          class="space-y-2 bg-background-bg-light/20 p-4 rounded-lg border border-color-primary/20"
        >
          <div class="flex items-center gap-2 text-normal-text">
            <svg
              xmlns="http://www.w3.org/2000/svg"
    ...
    >
      ...
      <div class="space-y-4">
        ...
        <div
          class="bg-background-bg-light/20 p-4 rounded-lg border border-color-secondary/20"
        >
          <div class="flex items-center gap-2 text-normal-text">
            <svg
              xmlns="http://www.w3.org/2000/svg"
