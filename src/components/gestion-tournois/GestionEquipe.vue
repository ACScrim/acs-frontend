    ...
    >
      ...
      <div class="flex flex-col md:flex-row items-start gap-6">
        <div class="w-full md:w-1/2">
          <SpaceTitle size="md" className="text-normal-text-muted mb-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="relative mb-6">
        ...
        >
          <template #icon>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 text-normal-text-muted"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
              <path
        ...
        >
          ...
          >
            <span class="font-medium text-normal-text">{{
        ...
        >
          ...
          >
            ...
            <vue-draggable-next
              ...
              "
              :disabled="selectedTournamentDetails?.finished"
              class="flex flex-col gap-2 min-h-[150px] max-h-[250px] overflow-y-auto p-3 bg-background-bg-secondary/50 border-2 border-dashed border-space-border/30 rounded-lg transition-all duration-300"
              :class="{
            ...
            >
              <div
                ...
                class="flex justify-between items-center p-3 bg-background-bg-primary/80 text-normal-text border border-color-secondary/50 rounded-lg shadow-sm shadow-color-secondary/30 transition-all duration-300 cursor-move hover:shadow-md hover:shadow-color-secondary/50 hover:-translate-y-0.5"
              >
                <span class="text-normal-text">{{ player.username }}</span>
                <div
                  class="flex items-center justify-center w-6 h-6 bg-background-bg-secondary/70 rounded"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div
                ...
                class="flex flex-col items-center justify-center w-full h-full min-h-[120px] p-6 text-normal-text-muted transition-all duration-300 bg-color-secondary/5 border-2 border-dashed border-color-secondary/30 rounded-lg"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-8 w-8 mb-2"
        ...
        >
          <template #header>
            ...
            >
              <div class="flex flex-col gap-3 w-full">
                ...
                <div class="flex items-center gap-2">
                  <span class="text-normal-text text-sm">Nom de l'équipe:</span>
                  <SpaceInput
          ...
          <div class="space-y-4">
            ...
            <vue-draggable-next
              ...
              "
              :disabled="selectedTournamentDetails?.finished"
              class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 min-h-[150px] p-4 bg-background-bg-secondary/30 border-2 border-dashed border-space-border/30 rounded-lg"
            ...
            >
              <div
                ...
                :key="player._id"
                :data-player-id="player._id"
                class="flex justify-between items-center p-3 bg-background-bg-primary/80 text-normal-text border border-color-primary/50 rounded-lg shadow-sm shadow-color-primary/30 transition-all duration-300 cursor-move hover:shadow-md hover:shadow-color-primary/50 hover:-translate-y-0.5"
              >
                <span class="text-normal-text">{{ player.username }}</span>
                <div
                  class="flex items-center justify-center w-6 h-6 bg-background-bg-secondary/70 rounded"
              ...
              <div
                ...
                class="col-span-full flex flex-col items-center justify-center w-full h-full min-h-[120px] p-6 text-normal-text-muted bg-color-primary/5 border-2 border-dashed border-color-primary/30 rounded-lg"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-8 w-8 mb-2"
      ...
      <SpaceCard variant="danger" :stars="true" className="mb-8">
        ...
        >
          <div
            ...
            :key="player._id"
            :data-player-id="player._id"
            class="flex flex-col p-3 bg-background-bg-primary/80 border border-space-danger/50 rounded-lg shadow-sm shadow-space-danger/30 transition-all duration-300 hover:shadow-md hover:shadow-space-danger/50 hover:-translate-y-0.5"
          >
            <div class="flex justify-between items-center mb-2">
              <span class="text-normal-text">{{ player.username }}</span>
              <div
                class="flex items-center justify-center w-6 h-6 bg-background-bg-secondary/70 rounded cursor-move"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-4 w-4 text-normal-text-muted"
            ...
            <select
              ...
              class="w-full py-1.5 px-2 text-xs bg-background-bg-secondary/70 text-normal-text border border-space-danger/40 rounded-md appearance-none cursor-pointer transition-all duration-300 focus:outline-none focus:border-space-danger/70 focus:shadow-sm focus:shadow-space-danger/30"
              @change="
                assignPlayerToTeam(
                  index,
          ...
          <div
            ...
            class="col-span-full flex flex-col items-center justify-center p-6 text-normal-text-muted bg-color-success/5 border-2 border-dashed border-color-success/30 rounded-lg min-h-[150px]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
