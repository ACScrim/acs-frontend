      ...
      >
          ...
          <table class="min-w-full west-table shadow-sm">
            <thead class="bg-background-bg-light/20">
              <tr>
                <th
                  scope="col"
                  class="px-6 py-4 text-center text-sm font-heading text-normal-text-muted uppercase tracking-wider"
                >
                  Rang
                </th>
                <th
                  scope="col"
                  class="px-6 py-3 text-center text-xs font-heading text-normal-text-muted uppercase tracking-wider"
                >
                  <div class="flex items-center justify-center">
                    <span>Joueur</span>
                    <button
                      @click="sortBy('username')"
                      class="ml-1 p-1 rounded-full h-6 w-6 flex items-center justify-center hover:bg-background-bg-light/50 focus:outline-none"
                      :class="{
              ...
              >
                ...
                <td class="px-6 py-3 whitespace-nowrap">
                  <router-link
                    ...
                    class="text-normal-text hover:text-color-primary-light font-heading transition-all duration-300 text-center text-lg"
                  >
                    {{ ranking.username }}
                  </router-link>
                </td>
        ...
        <div class="block md:hidden">
          ...
          >
            ...
            >
              <span
                class="font-heading text-normal-text-muted text-sm whitespace-nowrap"
                >Trier par:</span
              >
              <!-- Boutons de tri -->
              <SpaceButton
              ...
              <div class="flex items-center">
                ...
                <div class="flex items-center ml-2 flex-shrink-0">
                  <div class="flex items-center">
                    ...
                    <span
                      class="text-xs text-normal-text-muted whitespace-nowrap"
                      >victoires</span
                    >
                  </div>
                </div>
