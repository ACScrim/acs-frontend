  ...
  >
        ...
        >
          <div class="flex items-center justify-between">
            ...
            <div class="flex flex-col items-center mx-2 sm:mx-4 min-w-0 flex-1">
              ...
              <div
                class="w-16 sm:w-20 h-1 bg-color-bg-light/30 rounded-full mt-2 overflow-hidden"
              >
                <div
    ...
    <div v-else class="tournament-details flex flex-col gap-4 sm:gap-6">
        ...
        >
          ...
          >
            <div class="text-center">
              ...
              <div
                class="text-color-text font-heading mt-2 text-sm sm:text-base"
              >
          ...
          <div
            class="absolute inset-0 bg-gradient-to-t from-color-bg/90 to-transparent"
          ></div>
        ...
        >
          ...
          <div class="space-y-3 sm:space-y-4">
            <div class="flex items-start gap-2">
              ...
              <div class="min-w-0 flex-1">
                <div
                  class="font-heading text-color-text-muted text-xs sm:text-sm"
                >
                  Date
                </div>
                ...
                <div class="flex items-center gap-x-4">
                  <div class="text-color-text break-words">
                  ...
                  <div v-if="tournament.date" class="flex items-center gap-1">
                    <a
                      ...
                      class="p-1 rounded hover:bg-color-bg-light/30 transition-colors text-[#4285F4] hover:text-[#3367D6]"
                    >
                    ...
                    <a
                      ...
                      class="p-1 rounded hover:bg-color-bg-light/30 transition-colors text-[#0078D4] hover:text-[#005A9E]"
                    >
            ...
            <div v-if="tournament.playerCap > 0" class="space-y-2">
              ...
              <div
                class="w-full bg-color-bg-light/30 rounded-full h-2 overflow-hidden"
              >
                <div
            ...
            <div
              v-if="hasWaitlist"
              class="border-t border-color-bg-light/30 pt-3"
            >
              <div class="flex items-start gap-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="min-w-0 flex-1">
                  ...
                  <div class="text-color-text">{{ waitlistCount }} joueurs</div>
                  <p
          ...
          <div class="space-y-3 sm:space-y-4">
            <div class="flex items-start gap-2">
              ...
              <div>
                ...
                <div class="text-color-text">{{ getParticipantsCount() }}</div>
              </div>
            </div>
          ...
          >
            ...
            <Button
              ...
              variant="secondary"
              @click="openRegistrationPopup(tournament, 'caster')"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <Button
              v-if="isUserCaster && !tournament.finished"
              @click="
                tournament._id && unregisterCaster(tournament._id, user._id)
              "
              variant="warning"
              className="w-full"
            >
      ...
      <Card variant="dark" :stars="true" className="overflow-hidden">
        ...
        <div
          class="space-tabs flex flex-wrap border-b border-color-bg-light/30 overflow-x-auto scrollbar-thin"
        >
          <!-- Onglet Description -->
          <button
            ...
            :class="[
              ...
              activeTab === 'description'
                ? 'text-color-primary-light bg-color-bg-light/20 border-b-2 border-color-primary'
                : 'text-color-text-muted hover:text-color-text hover:bg-color-bg-light/10',
            ]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <button
            ...
            :class="[
              'space-tab px-3 sm:px-4 py-2 sm:py-3 font-heading text-sm sm:text-base flex items-center whitespace-nowrap',
              activeTab === 'twitch'
                ? 'text-color-accent-light bg-color-bg-light/20 border-b-2 border-color-accent'
                : 'text-color-text-muted hover:text-color-text hover:bg-color-bg-light/10',
            ]"
          >
            <svg
          ...
          <button
            ...
            :class="[
              'space-tab px-3 sm:px-4 py-2 sm:py-3 font-heading text-sm sm:text-base flex items-center whitespace-nowrap',
              activeTab === 'results'
                ? 'text-color-success-light bg-color-bg-light/20 border-b-2 border-color-success'
                : 'text-color-text-muted hover:text-color-text hover:bg-color-bg-light/10',
            ]"
          >
            <svg
        ...
        <div class="p-3 sm:p-6">
          ...
          >
            ...
            <Card variant="dark" className="p-3 sm:p-4">
              <p
                ...
                class="text-color-text leading-relaxed text-sm sm:text-base break-words"
                v-html="formatDescription(tournament.description)"
              ></p>
              <p
                v-else
                class="text-color-text-muted italic text-sm sm:text-base"
              >
          ...
          >
            ...
            >
              ...
              >
                <h4
                  class="text-sm sm:text-base text-color-text font-heading border-b border-color-bg-light/30 pb-2 mb-2 truncate"
                >
                  {{ team.name }}
                </h4>
                <ul class="space-y-1">
                  <li
                    ...
                    :key="teamPlayer._id"
                    class="flex items-center justify-between p-2 bg-color-bg-light/10 rounded-md border-l-2 border-color-secondary/50 text-sm sm:text-base"
                  >
                    <router-link
                      v-if="teamPlayer._id"
                    ...
                    <span
                      v-else
                      class="text-color-text truncate min-w-0 flex-1"
                    >
            ...
            <div v-if="hasWaitlist" class="mt-6 sm:mt-8 space-fade-in">
              <h3
                class="text-lg sm:text-xl text-color-text font-heading mb-3 sm:mb-4 flex items-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <Card variant="warning" className="p-3">
                ...
                <div
                  class="hidden sm:grid grid-cols-3 gap-4 mb-3 text-base sm:text-lg font-heading text-color-text-muted border-b border-color-bg-light/20 pb-2"
                >
                  <div>Position</div>
                  <div>Joueur</div>
                ...
                <ul v-if="waitlistPlayers.length > 0" class="space-y-2">
                  <li
                    ...
                    :key="player._id"
                    class="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4 p-2 rounded-md text-color-text hover:bg-color-bg-light/10 transition-colors"
                  >
                    ...
                    <!-- Temps d'attente -->
                    <div class="text-color-text-muted text-sm sm:text-base">
                ...
                <p
                  v-else
                  class="text-color-text-muted italic text-center py-4 text-sm sm:text-base"
                >
      ...
      >
        ...
        >
          <h3
            class="text-lg sm:text-xl font-heading flex items-center text-color-text"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 mr-2"
            ...
            <div class="p-3">
              <div class="space-y-2">
                <div
                  ...
                  :key="player._id"
                  class="flex items-center p-2 bg-color-bg-light/10 hover:bg-color-bg-light/20 transition-colors rounded-md min-w-0"
                >
                  <router-link
                    v-if="player._id"
                    :to="{ name: 'Profil', params: { id: player._id } }"
                    class="text-color-text hover:text-color-primary-light transition-colors text-sm sm:text-base truncate min-w-0 flex-1"
                  >
                    {{ player.username }}
                  </router-link>
                  <span
                    v-else
                    class="text-color-text text-sm sm:text-base truncate min-w-0 flex-1"
                  >
                    {{ player.username || "Joueur inconnu" }}
                  </span>
                </div>
    ...
    <Modal v-model="showLevelPrompt" title="NIVEAU DE JEU REQUIS">
      <div class="space-y-3 sm:space-y-4">
        ...
        <p class="text-color-text-muted text-sm sm:text-base">
