  ...
  >
    ...
    >
      ...
      <div v-if="hasNavigation" class="w-full sm:hidden">
        <SpaceCard
          variant="dark"
          className="px-3 py-2 border border-color-primary/30"
        >
          <div class="flex items-center justify-between">
            ...
            <div class="flex flex-col items-center mx-2 sm:mx-4 min-w-0 flex-1">
              <div
                class="text-xs text-color-primary-light font-nasa mb-1 text-center"
              >
                TOURNOI
              </div>
              <div class="flex items-center space-x-1 sm:space-x-2">
                ...
                <span
                  class="text-normal-text-muted font-mono text-sm sm:text-base"
                  >/</span
                >
                <SpaceBadge
                  variant="secondary"
              ...
              <div
                class="w-16 sm:w-20 h-1 bg-background-bg-light/30 rounded-full mt-2 overflow-hidden"
              >
                <div
                  class="h-full bg-gradient-to-r from-color-primary to-color-secondary rounded-full transition-all duration-500"
                  :style="`width: ${
      ...
      <div class="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-40">
        <SpaceCard variant="dark" className="px-4 py-2">
          <div class="text-center">
            <div class="text-xs text-color-primary-light font-nasa">
              TOURNOI
            </div>
    ...
    <div v-else class="tournament-details flex flex-col gap-4 sm:gap-6">
      ...
      >
        ...
        >
          ...
          <div
            v-else
            class="w-full h-full flex items-center justify-center bg-background-bg-light"
          >
            <div class="text-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-16 sm:h-20 lg:h-24 w-16 sm:w-20 lg:w-24 text-color-primary/60 mx-auto"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
              ...
              <div
                class="text-normal-text font-heading mt-2 text-sm sm:text-base"
              >
          ...
          <div
            class="absolute inset-0 bg-gradient-to-t from-background-bg/90 to-transparent"
          ></div>
        ...
        >
          ...
          <div class="space-y-3 sm:space-y-4">
            <div class="flex items-start gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 mt-0.5 text-color-primary flex-shrink-0"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
              ...
              <div class="min-w-0 flex-1">
                <div
                  class="font-heading text-normal-text-muted text-xs sm:text-sm"
                >
                  Date
                </div>
                ...
                <div class="flex items-center gap-x-4">
                  <div class="text-normal-text break-words">
                  ...
                  <div v-if="tournament.date" class="flex items-center gap-1">
                    <a
                      :href="generateGoogleCalendarLink(tournament.date)"
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="Ajouter à Google Calendar"
                      title="Ajouter à Google Calendar"
                      class="p-1 rounded hover:bg-background-bg-light/30 transition-colors text-[#4285F4] hover:text-[#3367D6]"
                    >
                    ...
                    <a
                      :href="generateOutlookCalendarLink(tournament.date)"
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="Ajouter à Outlook Calendar"
                      title="Ajouter à Outlook Calendar"
                      class="p-1 rounded hover:bg-background-bg-light/30 transition-colors text-[#0078D4] hover:text-[#005A9E]"
                    >
            ...
            <div class="flex items-start gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 mt-0.5 text-color-secondary flex-shrink-0"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
            ...
            <div v-if="tournament.playerCap > 0" class="space-y-2">
              <div class="flex items-start gap-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-5 w-5 mt-0.5 text-color-accent flex-shrink-0"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
              ...
              <div
                class="w-full bg-background-bg-light/30 rounded-full h-2 overflow-hidden"
              >
                <div
            ...
            <div
              v-if="hasWaitlist"
              class="border-t border-background-bg-light/30 pt-3"
            >
              <div class="flex items-start gap-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-5 w-5 mt-0.5 text-color-warning flex-shrink-0"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
                ...
                <div class="min-w-0 flex-1">
                  ...
                  <p
                    ...
                    class="text-base sm:text-lg text-color-warning mt-1 break-words"
                  >
          ...
          <div class="space-y-3 sm:space-y-4">
            <div class="flex items-start gap-2">
              ...
              <div>
                ...
                <div class="text-normal-text">{{ getParticipantsCount() }}</div>
              </div>
            </div>
      ...
      <SpaceCard variant="dark" :stars="true" className="overflow-hidden">
        ...
        <div
          class="space-tabs flex flex-wrap border-b border-background-bg-light/30 overflow-x-auto scrollbar-thin"
        >
          <!-- Onglet Description -->
          <button
            ...
            :class="[
              ...
              activeTab === 'description'
                ? 'text-color-primary-light bg-background-bg-light/20 border-b-2 border-color-primary'
                : 'text-normal-text-muted hover:text-normal-text hover:bg-background-bg-light/10',
            ]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <button
            ...
            :class="[
              'space-tab px-3 sm:px-4 py-2 sm:py-3 font-heading text-sm sm:text-base flex items-center whitespace-nowrap',
              activeTab === 'twitch'
                ? 'text-color-accent-light bg-background-bg-light/20 border-b-2 border-color-accent'
                : 'text-normal-text-muted hover:text-normal-text hover:bg-background-bg-light/10',
            ]"
          >
            <svg
          ...
          <button
            ...
            :class="[
              'space-tab px-3 sm:px-4 py-2 sm:py-3 font-heading text-sm sm:text-base flex items-center whitespace-nowrap',
              activeTab === 'results'
                ? 'text-color-success-light bg-background-bg-light/20 border-b-2 border-color-success'
                : 'text-normal-text-muted hover:text-normal-text hover:bg-background-bg-light/10',
            ]"
          >
            <svg
        ...
        <div class="p-3 sm:p-6">
          ...
          >
            <h3
              class="text-base sm:text-lg text-normal-text font-heading mb-3 sm:mb-4 flex items-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <SpaceCard variant="dark" className="p-3 sm:p-4">
              <p
                ...
                class="text-normal-text leading-relaxed text-sm sm:text-base break-words"
                v-html="formatDescription(tournament.description)"
              ></p>
              <p
                v-else
                class="text-normal-text-muted italic text-sm sm:text-base"
              >
          ...
          >
            ...
            >
              ...
              >
                <h4
                  class="text-sm sm:text-base text-normal-text font-heading border-b border-background-bg-light/30 pb-2 mb-2 truncate"
                >
                  {{ team.name }}
                </h4>
                <ul class="space-y-1">
                  <li
                    ...
                    :key="teamPlayer._id"
                    class="flex items-center justify-between p-2 bg-background-bg-light/10 rounded-md border-l-2 border-color-secondary/50 text-sm sm:text-base"
                  >
                    <router-link
                      v-if="teamPlayer._id"
                      :to="{ name: 'Profil', params: { id: teamPlayer._id } }"
                      class="text-normal-text hover:text-color-secondary-light transition-colors truncate min-w-0 flex-1"
                    >
                      {{ teamPlayer.username }}
                    </router-link>
                    <span
                      v-else
                      class="text-normal-text truncate min-w-0 flex-1"
                    >
            ...
            >
              ...
              >
                <div
                  ...
                  :key="player._id"
                  class="flex items-center justify-between p-2 sm:p-3 bg-background-bg-light/10 rounded-lg border-l-2 border-color-primary/50 font-nasa text-sm sm:text-base lg:text-xl min-w-0"
                >
                  <router-link
                    v-if="player._id"
                    :to="{ name: 'Profil', params: { id: player._id } }"
                    class="text-normal-text hover:text-color-primary-light transition-colors truncate min-w-0 flex-1"
                  >
                    {{ player.username }}
                  </router-link>
                  <span v-else class="text-normal-text truncate min-w-0 flex-1">
            ...
            <SpaceAlert
              v-else
              variant="info"
              className="bg-background-bg-light/10 text-center py-4 sm:py-6"
            >
              <p class="text-normal-text-muted italic text-sm sm:text-base">
            ...
            <div v-if="hasWaitlist" class="mt-6 sm:mt-8 space-fade-in">
              <h3
                class="text-lg sm:text-xl text-normal-text font-heading mb-3 sm:mb-4 flex items-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-5 w-5 sm:h-6 sm:w-6 mr-2 text-color-warning"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
              ...
              <SpaceCard variant="warning" className="p-3">
                ...
                <div
                  class="hidden sm:grid grid-cols-3 gap-4 mb-3 text-base sm:text-lg font-heading text-normal-text-muted border-b border-background-bg-light/20 pb-2"
                >
                  <div>Position</div>
                  <div>Joueur</div>
                ...
                <ul v-if="waitlistPlayers.length > 0" class="space-y-2">
                  <li
                    ...
                    :key="player._id"
                    class="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4 p-2 rounded-md text-normal-text hover:bg-background-bg-light/10 transition-colors"
                  >
                    <!-- Position (mobile: inline, desktop: column) -->
                    <div class="sm:text-center">
                      <span class="sm:hidden text-xs text-normal-text-muted"
                        >Position:
                      </span>
                    ...
                    <div>
                      ...
                      <router-link
                        v-if="player._id"
                        :to="{ name: 'Profil', params: { id: player._id } }"
                        class="text-normal-text hover:text-color-primary-light transition-colors"
                      >
                        {{ player.username }}
                      </router-link>
                      <span v-else>{{
                    ...
                    <!-- Temps d'attente -->
                    <div class="text-normal-text-muted text-sm sm:text-base">
                ...
                <p
                  v-else
                  class="text-normal-text-muted italic text-center py-4 text-sm sm:text-base"
                >
      ...
      >
        ...
        >
          <h3
            class="text-lg sm:text-xl font-heading flex items-center text-normal-text"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 mr-2"
          ...
          >
            ...
            >
              <div class="flex items-center min-w-0 flex-1">
                ...
                <h5
                  class="text-normal-text font-heading text-sm sm:text-base truncate"
                >
                  {{ team.name }}
                </h5>
              </div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 sm:h-6 sm:w-6 text-color-success flex-shrink-0"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
            ...
            <div class="p-3">
              <div class="space-y-2">
                <div
                  ...
                  :key="player._id"
                  class="flex items-center p-2 bg-background-bg-light/10 hover:bg-background-bg-light/20 transition-colors rounded-md min-w-0"
                >
                  <router-link
                    v-if="player._id"
                    :to="{ name: 'Profil', params: { id: player._id } }"
                    class="text-normal-text hover:text-color-primary-light transition-colors text-sm sm:text-base truncate min-w-0 flex-1"
                  >
                    {{ player.username }}
                  </router-link>
                  <span
                    v-else
                    class="text-normal-text text-sm sm:text-base truncate min-w-0 flex-1"
                  >
                    {{ player.username || "Joueur inconnu" }}
                  </span>
                </div>
    ...
    >
      <div class="space-y-3 sm:space-y-4">
        <p class="text-normal-text text-sm sm:text-base">
          Voulez-vous
          ...
          au tournoi
          <span class="text-color-secondary-light font-bold break-words">
    ...
    <SpaceModal v-model="showLevelPrompt" title="NIVEAU DE JEU REQUIS">
      <div class="space-y-3 sm:space-y-4">
        <p class="text-normal-text text-sm sm:text-base">
          ...
          <span class="text-color-primary-light font-bold break-words">{{
            levelPromptGameName
          }}</span
          >.
        </p>
        <p class="text-normal-text-muted text-sm sm:text-base">
...
const generateOutlookCalendarLink = (dateString: string) => {
  try {
    ...
    const format = (d: Date) => d.toISOString().replace(/\.\d{3}Z$/, "Z"); // YYYY-MM-DDTHH:mm:ssZ
    ...
    const location =
      ...
      tournament.value?.game?.name ??
      "ACS";
    const body = `Plus d'infos: https://acscrim.fr/tournois/${
      tournament.value?._id ?? ""
    }`;
...
.space-tabs {
  ...
  scrollbar-color: var(--background-bg-light) transparent;
}
...
@media (hover: none) and (pointer: coarse) {
  ...
  .hover\:bg-background-bg-light\/10:hover {
    background-color: rgba(var(--background-bg-light-rgb), 0.15);
  }
}
