          ...
          <div class="space-y-4">
            ...
            >
              <div class="flex items-center justify-between">
                <div class="text-normal-text font-mono text-sm">
        ...
        <SpaceCard variant="secondary" :stars="true" :decorated="true">
          ...
          <SpaceCard variant="dark" className="mb-6">
            <div class="flex items-start space-x-2">
              ...
              <div>
                ...
                <ul class="space-y-1 text-normal-text-muted">
                  <li>
            ...
            >
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                  ...
                  <!-- Détails -->
                  <div>
                    <h3 class="text-normal-text font-nasa text-sm mb-1">
                      🏆 Tournois
                    </h3>
                    <p class="text-normal-text-muted text-xs">
          ...
          <div class="mt-6 pt-4 border-t border-space-border">
            <div class="flex items-center justify-between text-sm">
              <span class="text-normal-text-muted">
              ...
              <div class="flex items-center space-x-2">
                ...
                <div v-else class="text-normal-text-muted font-mono">
                  {{
            ...
            >
              <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                  ...
                  <div
                    v-else
                    class="w-12 h-12 rounded-lg bg-background-bg-light flex items-center justify-center border-2 border-color-secondary/50"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
