<template>
  ...
  >
    ...
    <Card
      ...
      :stars="true"
      :decorated="true"
      className="max-w-md md:max-w-lg lg:max-w-2xl w-full z-10 relative backdrop-blur-sm"
    >
      <div class="text-center mb-6">
        ...
        <div class="relative inline-block mb-6">
          ...
          >
            <svg
              ...
              class="h-12 w-12 md:h-16 md:w-16 text-color-error"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
        ...
        <Title
          size="2xl"
          :glitch="true"
          className="mb-4 text-color-error lg:text-4xl"
        >
          {{ title }}
        </Title>

        <!-- Message d'erreur -->
        <p class="text-color-text mb-8 text-base md:text-lg">{{ message }}</p>
        ...
        <div v-if="errorType === 'guild_required'" class="space-y-6 mb-6">
          ...
          <p class="text-color-text-muted text-center lg:text-left">
