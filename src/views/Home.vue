  ...
  >
    ...
    >
      ...
      >
        ...
        <div
          v-else
          class="mt-4 sm:mt-6 max-w-sm p-3 rounded-lg border-2 border-color-secondary/70 bg-gradient-to-br from-background-bg-light/80 to-background-bg/90 backdrop-blur-md shadow-lg shadow-color-secondary/20 animate-float-subtle relative overflow-hidden"
        >
          <!-- Effet de brillance -->
          <div
        ...
        >
          ...
          <div v-else-if="nextTournament" class="space-y-3">
            <TournamentCard :tournament="nextTournament" variant="primary">
              <template #content>
                <div class="flex flex-wrap gap-y-1 gap-x-2 xs:gap-x-3">
                  <div
                    class="text-3xs xs:text-2xs sm:text-xs text-normal-text flex items-center"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="grid grid-cols-2 gap-4">
              <div>
                <div class="text-normal-text font-mono">
        ...
        >
          ...
          <div v-else-if="lastFinishedTournament" class="space-y-3">
              ...
              <div class="space-y-2">
                ...
                >
                  ...
                  <div
                    ...
                    class="mt-2 pl-12"
                  >
                    <div class="text-xs text-normal-text-muted mb-1">
                      Membres:
                    </div>
            ...
            <div class="flex justify-between items-center">
              <div
                class="text-normal-text-muted text-3xs xs:text-2xs sm:text-xs flex items-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
