  ...
  <SpaceContainer>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div
                class="flex items-center space-x-3 p-3 rounded-lg bg-background-bg-light/50 border border-color-primary/30 hover:border-color-primary/60 transition-colors duration-300"
              >
                <input
                  id="categoryTypeAcs"
                ...
                <label
                  for="categoryTypeAcs"
                  class="text-normal-text font-nasa cursor-pointer"
                >
                  Badge ACS (général)
                </label>
              </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div class="badge-preview">
              <div
                class="w-20 h-20 rounded-full flex items-center justify-center bg-gradient-to-br from-background-bg-dark to-background-bg-light p-1 border-2 border-color-primary/50 overflow-hidden shadow-lg"
              >
                <img
    ...
    >
      ...
      <form @submit.prevent="assignBadge" class="space-y-6">
        ...
        <div class="mb-6">
          ...
          <div class="relative">
            <input
              ...
              @blur="hidePlayerList"
              @input="searchPlayers"
              class="w-full py-3 px-4 bg-background-bg-light/50 text-normal-text border border-color-secondary/50 rounded-lg font-nasa shadow-glow-secondary-sm transition-all duration-300 focus:outline-none focus:border-color-secondary focus:shadow-glow-secondary"
            ...
            >
              <ul class="py-1">
                <li
                  ...
                  class="px-4 py-3 cursor-pointer transition-colors hover:bg-color-secondary/20 text-normal-text font-nasa text-sm"
                >
                  {{ player.username }}
                </li>
                <li
                  v-if="filteredPlayers.length === 0"
                  class="px-4 py-3 text-normal-text-muted italic text-center text-sm"
                >
                  Aucun joueur trouvé
                </li>
              </ul>
          ...
          <div class="flex flex-wrap gap-2 mt-4">
            <div
              ...
              :key="player._id"
              class="flex items-center bg-color-secondary/20 text-normal-text px-3 py-2 rounded-full text-sm border border-color-secondary/50 transition-all hover:bg-color-secondary/30 hover:border-color-secondary/70 hover:shadow-glow-secondary font-nasa"
            >
              {{ player.username }}
              <button
                @click="removePlayer(player)"
                class="ml-2 text-normal-text-muted hover:text-space-danger transition-colors"
                type="button"
        ...
        <div class="mt-6">
          ...
          <div
            v-if="badgeId"
            class="mt-4 flex items-center bg-background-bg-light/50 rounded-lg p-3 border border-color-secondary/30"
          >
            <div
              class="w-10 h-10 rounded-full flex items-center justify-center bg-gradient-to-br from-background-bg-dark to-background-bg-light p-1 mr-3 border border-color-secondary/40 overflow-hidden"
            >
              <img
            ...
            <span class="text-normal-text font-nasa">{{
    ...
    >
      ...
      <div class="space-y-6">
        <div>
          ...
          <div class="relative">
            <input
              ...
              class="w-full py-3 px-4 bg-background-bg-light/50 text-normal-text border border-color-accent/50 rounded-lg font-nasa shadow-glow-accent-sm transition-all duration-300 focus:outline-none focus:border-color-accent focus:shadow-glow-accent"
            ...
            >
              <ul class="py-1">
                <li
                  ...
                  class="px-4 py-3 cursor-pointer transition-colors hover:bg-color-accent/20 text-normal-text font-nasa text-sm"
                >
                  {{ player.username }}
                </li>
                <li
        ...
        <div
          ...
          class="flex items-center justify-between bg-background-bg-light border border-color-accent/40 px-4 py-3 rounded-lg"
        >
          <div class="flex items-center">
            <span class="text-normal-text font-body text-lg">{{
        ...
        >
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div
              ...
              :key="badge._id"
              class="bg-background-bg-light rounded-lg p-4 flex items-center justify-between border border-color-accent/40 hover:border-color-accent/70 hover:shadow-lg hover:shadow-color-accent/20 hover:-translate-y-1 transition-all duration-300"
            >
              <div class="flex items-center">
                <div
                  class="w-14 h-14 rounded-full flex items-center justify-center bg-gradient-to-br from-background-bg-dark to-background-bg-light p-1 mr-4 border-2 border-color-primary/30 overflow-hidden shadow-lg"
                >
                  <img
                    :src="badge.imageUrl"
                    :alt="badge.title"
                ...
                <span class="text-normal-text font-body">{{
                  badge.title
                }}</span>
              </div>
              <SpaceButton
    ...
    <SpaceCard variant="info" :stars="true" :decorated="true" className="mb-6">
      ...
      >
        <div
          ...
          :key="badge._id"
          class="bg-background-bg-light rounded-lg p-4 flex flex-col items-center border border-color-info/40 hover:border-color-info/70 hover:shadow-lg hover:shadow-color-info/20 hover:-translate-y-1 transition-all duration-300 group"
        >
          ...
          <div
            class="w-16 h-16 rounded-full flex items-center justify-center bg-gradient-to-br from-background-bg-dark to-background-bg-light p-1 mb-3 border-2 border-color-primary/30 overflow-hidden shadow-lg group-hover:shadow-color-primary/30 group-hover:border-color-primary/50 transition-all duration-300"
          >
            <img
              :src="badge.imageUrl"
              :alt="badge.title"
          ...
          <span class="text-normal-text font-body text-center line-clamp-2">
            {{ badge.title }}
          </span>
          <!-- Description conditionnelle -->
          <p
            v-if="badge.description"
            class="text-normal-text-muted text-xs mt-2 text-center line-clamp-3"
          >
            {{ badge.description }}
          </p>
      ...
      >
        ...
        <p class="text-normal-text font-body text-center">
          Aucun badge n'a été créé pour le moment
        </p>
        <p class="text-normal-text-muted text-sm mt-2 font-body text-center">
    ...
    <SpaceModal v-model="showEditModal" title="Modifier le badge">
      <form @submit.prevent="updateBadge" class="space-y-6">
        ...
        <div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div
              class="flex items-center space-x-3 p-3 rounded-lg bg-background-bg-light/50 border border-color-info/30 hover:border-color-info/60 transition-colors duration-300"
            >
              <input
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          >
            ...
            <div class="badge-preview">
              <div
                class="w-16 h-16 rounded-full flex items-center justify-center bg-gradient-to-br from-background-bg-dark to-background-bg-light p-1 border-2 border-color-primary/50 overflow-hidden shadow-lg"
              >
                <img
    ...
    <SpaceModal v-model="showDeleteModal" title="Confirmer la suppression">
      <div class="text-center space-y-6">
        ...
        <div class="space-y-2">
          <p class="text-normal-text font-body text-lg">
