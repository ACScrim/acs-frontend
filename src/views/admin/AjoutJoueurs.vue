        ...
        <SpaceCard variant="secondary" :stars="true" :decorated="true">
          ...
          <div v-else-if="players.length > 0" class="space-y-3">
            <div
              ...
              :key="player._id"
              class="group bg-background-bg-light/30 backdrop-blur-sm rounded-lg p-3 border border-color-secondary/20 hover:border-color-secondary/50 transition-all duration-300 flex justify-between items-center relative overflow-hidden hover:shadow-glow-secondary"
            >
              <div
              ...
              ></div>
              <span class="text-normal-text font-nasa z-10">{{
                player.username
              }}</span>
              <SpaceButton
