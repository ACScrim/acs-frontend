    ...
    <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
        ...
        <SpaceCard variant="secondary" :stars="true" :decorated="true">
          ...
          <div v-else class="space-y-3">
            <div
              ...
              :key="season._id"
              :class="[
                'group bg-background-bg-light/5 border rounded-lg p-4 transition-all duration-300',
      ...
      <div class="xl:col-span-7">
        ...
        >
          ...
          >
            <div class="text-normal-text-muted text-center">
        ...
        <div v-else class="space-y-6">
          ...
          <SpaceCard variant="accent" :stars="true" :decorated="true">
            ...
            <div class="border-b border-background-bg-light/30 -mx-6 px-6">
          ...
          <SpaceCard variant="primary" className="min-h-[200px]">
            ...
            >
              <div
                ...
                :key="tournament._id"
                class="bg-background-bg-light/5 border border-color-primary/30 rounded-lg p-3 hover:shadow-glow-primary hover:border-color-primary/50 transition-all duration-300"
              >
                <div class="flex justify-between items-start">
                  <div>
                    <h4 class="font-nasa text-normal-text text-sm">
                      {{ tournament.name }}
                    </h4>
                    <p
          ...
          <SpaceCard variant="secondary" className="min-h-[200px]">
            ...
            >
              <div
                ...
                :key="tournament._id"
                class="bg-background-bg-light/5 border border-color-secondary/30 rounded-lg p-3 hover:shadow-glow-secondary hover:border-color-secondary/50 transition-all duration-300"
              >
                <div class="flex justify-between items-start">
                  <div>
                    <h4 class="font-nasa text-normal-text text-sm">
