  ...
  <div class="container mx-auto p-8 pt-20">
    ...
    >
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          ...
          <p
            class="text-normal-text font-body text-sm sm:text-base leading-relaxed"
          >
      ...
      <div class="space-y-4">
            ...
            >
              ...
              <template #rightIcon>
                <button
                  v-if="searchQuery"
                  @click="clearSearch"
                  class="text-normal-text-muted hover:text-normal-text"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5"
        ...
        >
          ...
          <div class="flex items-center gap-2">
            <span class="text-normal-text-muted font-nasa text-sm">Tri:</span>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
      ...
      >
        ...
        <div class="text-xs text-normal-text-muted font-nasa">Joueurs</div>
      </SpaceCard>
      ...
      >
        ...
        <div class="text-xs text-normal-text-muted font-nasa">Utilisateurs</div>
      </SpaceCard>
      ...
      >
        ...
        <div class="text-xs text-normal-text-muted font-nasa">Synchronisés</div>
      </SpaceCard>
      ...
      >
        ...
        <div class="text-xs text-normal-text-muted font-nasa">En attente</div>
      </SpaceCard>
    </div>
        ...
        <div class="max-h-96 overflow-y-auto">
          <div class="space-y-3 p-4">
            <div
              ...
              :key="player._id"
              class="group bg-background-bg-light/5 hover:bg-background-bg-light/10 rounded-lg p-4 border border-color-primary/20 hover:border-color-primary/50 transition-all duration-300 cursor-pointer"
              :class="{
            ...
            >
              <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <div class="text-normal-text font-nasa font-medium">
                      {{ player.username }}
                    </div>
                    <div class="text-xs text-normal-text-muted font-mono">
        ...
        <div class="max-h-96 overflow-y-auto">
          <div class="space-y-3 p-4">
            <div
              ...
              :key="user._id"
              class="bg-background-bg-light/5 hover:bg-background-bg-light/10 rounded-lg p-4 border border-color-secondary/20 hover:border-color-secondary/50 transition-all duration-300"
              :class="{
            ...
            >
              <div class="flex items-center gap-3">
                ...
                <div class="flex-1 min-w-0">
                  <div class="text-normal-text font-nasa font-medium truncate">
                    {{ user.username }}
                  </div>
                  <div
                    class="text-xs text-normal-text-muted font-mono truncate"
                  >
                    {{ user.email }}
                  </div>
                  <div
