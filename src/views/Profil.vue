    ...
    <div v-else-if="player" class="max-w-4xl mx-auto">
      ...
      >
        ...
        <div class="text-center">
          ...
          <div class="avatar-container inline-block mb-4">
            ...
            <div
              v-else
              class="h-20 w-20 sm:h-24 sm:w-24 rounded-full bg-background-bg-light flex items-center justify-center border-2 border-color-primary mx-auto"
            >
      ...
      >
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <div class="text-normal-text-muted text-sm">Victoires</div>
          </SpaceCard>
          <SpaceCard
            variant="dark"
            className="text-center transform transition-all hover:scale-105 hover:bg-background-bg-light/90 duration-300"
          >
            ...
            <div class="text-normal-text-muted text-sm">Tournois</div>
          </SpaceCard>
        </div>
      </SpaceCard>
      ...
      >
        ...
        <div class="flex flex-wrap justify-center gap-4 mb-4">
          ...
          >
            ...
            <div class="text-xs text-normal-text-muted">2e places</div>
          </SpaceCard>
          <!-- Or -->
          <SpaceCard
            variant="gold"
          ...
          >
            ...
            <div class="text-xs text-normal-text-muted">victoires</div>
          </SpaceCard>
          ...
          >
            ...
            <div class="text-xs text-normal-text-muted">3e places</div>
          </SpaceCard>
        </div>
      </SpaceCard>
      ...
      >
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          >
            ...
            <div class="text-xs text-normal-text-muted">depuis</div>
          </SpaceCard>
          ...
          >
            ...
            <div class="text-xs text-normal-text-muted">dernière fois</div>
          </SpaceCard>
          ...
          >
            ...
            <div class="text-xs text-normal-text-muted">tournois joués</div>
          </SpaceCard>
        </div>
      </SpaceCard>
            ...
            >
              ...
              <div class="flex items-center flex-1 min-w-0">
                <div class="relative mr-4 flex-shrink-0">
                  ...
                  <div
                    v-else
                    class="w-12 h-12 rounded-lg bg-background-bg-light flex items-center justify-center border-2 border-color-primary/50"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              >
                ...
                <div class="flex items-center sm:text-right sm:mb-2">
                  ...
                  <div
                    class="text-xs text-normal-text-muted sm:text-center ml-2"
                  >
                    % taux de victoire
                  </div>
                </div>
                ...
                <div
                  class="w-16 sm:w-32 h-2 bg-[var(--background-bg-light)] rounded-full overflow-hidden ml-4 sm:ml-0 mt-2"
                >
                  <div
            ...
            >
              ...
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center flex-1 min-w-0">
                    <div
                      class="w-10 h-10 rounded-full bg-background-bg-light border-2 border-color-secondary/50 flex items-center justify-center mr-3 flex-shrink-0"
                    >
                    ...
                    <router-link
                      ...
                      class="text-normal-text hover:text-color-secondary-light transition-colors truncate"
                    >
                      {{ teammate.username }}
                    </router-link>
                  </div>
                  <div class="text-right flex items-center ml-3">
                    ...
                    <div
                      class="text-xs text-normal-text-muted ml-2 whitespace-nowrap"
                    >
                      équipes
                    </div>
                  </div>
              ...
              >
                <span class="text-xs text-normal-text-muted font-mono">
            ...
            >
              ...
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center flex-1 min-w-0">
                    <div
                      class="w-10 h-10 rounded-full bg-background-bg-light border-2 border-color-accent/50 flex items-center justify-center mr-3 flex-shrink-0"
                    >
                    ...
                    <router-link
                      ...
                      class="text-normal-text hover:text-color-accent-light transition-colors truncate"
                    >
                      {{ partner.username }}
                    </router-link>
                  </div>
                  <div class="text-right flex items-center ml-3">
                    ...
                    <div
                      class="text-xs text-normal-text-muted ml-2 whitespace-nowrap flex items-center"
                    >
      ...
      >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          >
            ...
            <div class="text-xs text-normal-text-muted">
          ...
          >
            ...
            <div class="text-xs text-normal-text-muted">des tournois</div>
          </SpaceCard>
          ...
          >
            ...
            <div class="text-xs text-normal-text-muted">de victoire</div>
          </SpaceCard>
          ...
          >
            ...
            <div class="text-xs text-normal-text-muted">de podiums</div>
          </SpaceCard>
        </div>
        ...
        <SpaceCard variant="dark" className="border border-color-accent/20">
          ...
          <div
            class="h-48 bg-background-bg rounded-lg p-4 border border-background-bg-light/20"
          >
            <div v-if="tournamentProgression.length > 0" class="h-full">
              <div class="flex justify-between items-end h-full relative">
                ...
                >
                  ...
                  <!-- Label du mois -->
                  <div
                    class="text-xs text-normal-text-muted mt-2 font-mono text-center"
                  >
                    {{ month.name }}
                  </div>
      ...
      >
              ...
              <SpaceCard variant="dark" className="w-full">
                ...
                >
                  ...
                  >
                    <!-- Date -->
                    <span
                      class="text-normal-text-muted text-sm font-mono order-1 sm:order-none"
        ...
        <SpaceTerminal
          ...
          :showCursor="true"
        >
          <div class="text-normal-text-muted">Aucun tournoi pour le moment</div>
        </SpaceTerminal>
      </SpaceCard>
    </div>
    ...
    >
      ...
      <div class="flex flex-col items-center">
        ...
        <SpaceCard variant="dark" className="w-full mt-2">
          <p class="text-normal-text text-sm text-center">
            {{
